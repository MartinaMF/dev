...
function portfolio_files(){
    ...
    wp_enqueue_script('progresscircle_portfolio_js', get_template_directory_uri() . '/dist/js/progresscircle.js' ,array('jquery'), filemtime(get_template_directory() . '/dist/js/progresscircle.js'), true);
